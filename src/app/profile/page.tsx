...
export default function ProfilePage() {
  ...
  if (!user) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-background px-6 py-10 text-center pb-32">
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-background p-4 pt-8 pb-32">
